...
public class Draw extends JPanel implements KeyListener
{
    ...
    protected Boolean paused = false; // Whether game is paused
    protected Boolean p1 = true; // Whether playing singleplayer of multiplayer
    ...
    public void menuFnc(int i)
    {
        ...
        ActionListener buttonListener = new ActionListener() 
        {
            public void actionPerformed(ActionEvent ae) 
            {
                ...
                {
                    // Makes menuFrame invisible and starts Single Player match
                ...
                try 
                    {
                        // Resets paddle positions before starting new match, waits one second before starting again.
        ...
        // Different text depending on whether first match, and which player won
        if (i == 0)
        {
